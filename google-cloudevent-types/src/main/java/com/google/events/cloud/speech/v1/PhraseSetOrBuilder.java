...
public interface PhraseSetOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.events.cloud.speech.v1.PhraseSet)
   ...
   */
  java.util.List<com.google.events.cloud.speech.v1.PhraseSet.Phrase> getPhrasesList();
   ...
   * <code>repeated .google.events.cloud.speech.v1.PhraseSet.Phrase phrases = 2;</code>
   */
  com.google.events.cloud.speech.v1.PhraseSet.Phrase getPhrases(int index);
   ...
   * <code>repeated .google.events.cloud.speech.v1.PhraseSet.Phrase phrases = 2;</code>
   */
  java.util.List<? extends com.google.events.cloud.speech.v1.PhraseSet.PhraseOrBuilder>
   ...
   * <code>repeated .google.events.cloud.speech.v1.PhraseSet.Phrase phrases = 2;</code>
   */
  com.google.events.cloud.speech.v1.PhraseSet.PhraseOrBuilder getPhrasesOrBuilder(int index);
   ...
   * @return The state.
   */
  com.google.events.cloud.speech.v1.PhraseSet.State getState();
