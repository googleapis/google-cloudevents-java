...
public interface HttpRouteOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.events.cloud.networkservices.v1.HttpRoute)
   ...
   * </pre>
   *
   * <code>repeated string hostnames = 5;</code>
   *
   ...
   * </pre>
   *
   * <code>repeated .google.events.cloud.networkservices.v1.HttpRoute.RouteRule rules = 6;</code>
   */
  java.util.List<com.google.events.cloud.networkservices.v1.HttpRoute.RouteRule> getRulesList();
   ...
   * <code>repeated .google.events.cloud.networkservices.v1.HttpRoute.RouteRule rules = 6;</code>
   */
  com.google.events.cloud.networkservices.v1.HttpRoute.RouteRule getRules(int index);
   ...
   * <code>repeated .google.events.cloud.networkservices.v1.HttpRoute.RouteRule rules = 6;</code>
   */
  java.util.List<? extends com.google.events.cloud.networkservices.v1.HttpRoute.RouteRuleOrBuilder>
   ...
   * <code>repeated .google.events.cloud.networkservices.v1.HttpRoute.RouteRule rules = 6;</code>
   */
  com.google.events.cloud.networkservices.v1.HttpRoute.RouteRuleOrBuilder getRulesOrBuilder(
      int index);
}
