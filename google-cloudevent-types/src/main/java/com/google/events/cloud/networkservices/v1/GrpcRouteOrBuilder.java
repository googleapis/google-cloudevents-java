...
public interface GrpcRouteOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.events.cloud.networkservices.v1.GrpcRoute)
   ...
   */
  java.util.List<com.google.events.cloud.networkservices.v1.GrpcRoute.RouteRule> getRulesList();
   ...
   * <code>repeated .google.events.cloud.networkservices.v1.GrpcRoute.RouteRule rules = 7;</code>
   */
  com.google.events.cloud.networkservices.v1.GrpcRoute.RouteRule getRules(int index);
   ...
   * <code>repeated .google.events.cloud.networkservices.v1.GrpcRoute.RouteRule rules = 7;</code>
   */
  java.util.List<? extends com.google.events.cloud.networkservices.v1.GrpcRoute.RouteRuleOrBuilder>
   ...
   * <code>repeated .google.events.cloud.networkservices.v1.GrpcRoute.RouteRule rules = 7;</code>
   */
  com.google.events.cloud.networkservices.v1.GrpcRoute.RouteRuleOrBuilder getRulesOrBuilder(
      int index);
}
