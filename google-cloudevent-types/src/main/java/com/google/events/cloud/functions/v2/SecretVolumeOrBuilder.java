...
public interface SecretVolumeOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.events.cloud.functions.v2.SecretVolume)
   ...
   * </code>
   */
  com.google.events.cloud.functions.v2.SecretVolume.SecretVersionOrBuilder getVersionsOrBuilder(
      int index);
}
