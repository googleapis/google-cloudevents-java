...
public interface ServiceConfigOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.events.cloud.functions.v2.ServiceConfig)
   ...
   */
  com.google.events.cloud.functions.v2.ServiceConfig.IngressSettings getIngressSettings();
   ...
   * </code>
   */
  com.google.events.cloud.functions.v2.SecretEnvVarOrBuilder getSecretEnvironmentVariablesOrBuilder(
      int index);
   ...
   * <code>repeated .google.events.cloud.functions.v2.SecretVolume secret_volumes = 19;</code>
   */
  com.google.events.cloud.functions.v2.SecretVolumeOrBuilder getSecretVolumesOrBuilder(int index);
   ...
   */
  com.google.events.cloud.functions.v2.ServiceConfig.SecurityLevel getSecurityLevel();
}
