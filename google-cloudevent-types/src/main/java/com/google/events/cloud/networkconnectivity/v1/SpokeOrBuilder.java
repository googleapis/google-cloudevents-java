...
public interface SpokeOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.events.cloud.networkconnectivity.v1.Spoke)
   ...
   * @return The state.
   */
  com.google.events.cloud.networkconnectivity.v1.State getState();
}
