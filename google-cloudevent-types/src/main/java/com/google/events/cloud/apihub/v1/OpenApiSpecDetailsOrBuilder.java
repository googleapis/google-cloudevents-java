...
public interface OpenApiSpecDetailsOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.events.cloud.apihub.v1.OpenApiSpecDetails)
   ...
   * @return The format.
   */
  com.google.events.cloud.apihub.v1.OpenApiSpecDetails.Format getFormat();
