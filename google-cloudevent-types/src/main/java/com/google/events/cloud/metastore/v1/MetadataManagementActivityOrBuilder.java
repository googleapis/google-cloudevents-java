...
public interface MetadataManagementActivityOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.events.cloud.metastore.v1.MetadataManagementActivity)
   ...
   * <code>repeated .google.events.cloud.metastore.v1.MetadataExport metadata_exports = 1;</code>
   */
  com.google.events.cloud.metastore.v1.MetadataExportOrBuilder getMetadataExportsOrBuilder(
      int index);
   ...
   * <code>repeated .google.events.cloud.metastore.v1.Restore restores = 2;</code>
   */
  com.google.events.cloud.metastore.v1.RestoreOrBuilder getRestoresOrBuilder(int index);
}
