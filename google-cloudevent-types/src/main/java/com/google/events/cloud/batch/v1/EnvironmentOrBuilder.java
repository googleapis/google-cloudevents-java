...
public interface EnvironmentOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.events.cloud.batch.v1.Environment)
   ...
   */
  com.google.events.cloud.batch.v1.Environment.KMSEnvMap getEncryptedVariables();
