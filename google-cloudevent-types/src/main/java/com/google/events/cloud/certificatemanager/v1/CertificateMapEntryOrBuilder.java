...
public interface CertificateMapEntryOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.events.cloud.certificatemanager.v1.CertificateMapEntry)
   ...
   * @return The matcher.
   */
  com.google.events.cloud.certificatemanager.v1.CertificateMapEntry.Matcher getMatcher();
   ...
   * @return The state.
   */
  com.google.events.cloud.certificatemanager.v1.ServingState getState();

  public com.google.events.cloud.certificatemanager.v1.CertificateMapEntry.MatchCase getMatchCase();
}
