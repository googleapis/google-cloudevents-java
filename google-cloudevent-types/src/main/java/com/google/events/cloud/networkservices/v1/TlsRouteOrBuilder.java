...
public interface TlsRouteOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.events.cloud.networkservices.v1.TlsRoute)
   ...
   */
  java.util.List<com.google.events.cloud.networkservices.v1.TlsRoute.RouteRule> getRulesList();
   ...
   * <code>repeated .google.events.cloud.networkservices.v1.TlsRoute.RouteRule rules = 5;</code>
   */
  com.google.events.cloud.networkservices.v1.TlsRoute.RouteRule getRules(int index);
   ...
   * <code>repeated .google.events.cloud.networkservices.v1.TlsRoute.RouteRule rules = 5;</code>
   */
  java.util.List<? extends com.google.events.cloud.networkservices.v1.TlsRoute.RouteRuleOrBuilder>
   ...
   * <code>repeated .google.events.cloud.networkservices.v1.TlsRoute.RouteRule rules = 5;</code>
   */
  com.google.events.cloud.networkservices.v1.TlsRoute.RouteRuleOrBuilder getRulesOrBuilder(
      int index);
