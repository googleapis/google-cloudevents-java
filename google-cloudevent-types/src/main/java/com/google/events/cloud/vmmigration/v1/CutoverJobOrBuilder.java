...
public interface CutoverJobOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.events.cloud.vmmigration.v1.CutoverJob)
   ...
   * @return The state.
   */
  com.google.events.cloud.vmmigration.v1.CutoverJob.State getState();
   ...
   * <code>repeated .google.events.cloud.vmmigration.v1.CutoverStep steps = 17;</code>
   */
  com.google.events.cloud.vmmigration.v1.CutoverStepOrBuilder getStepsOrBuilder(int index);

  public com.google.events.cloud.vmmigration.v1.CutoverJob.TargetVmDetailsCase
