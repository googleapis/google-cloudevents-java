...
public interface FederationOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.events.cloud.metastore.v1.Federation)
   ...
   */
  /* nullable */
  com.google.events.cloud.metastore.v1.BackendMetastore getBackendMetastoresOrDefault(
      int key,
      /* nullable */
   ...
   * </code>
   */
  com.google.events.cloud.metastore.v1.BackendMetastore getBackendMetastoresOrThrow(int key);
   ...
   * @return The state.
   */
  com.google.events.cloud.metastore.v1.Federation.State getState();
