...
public interface ClientGatewayOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.events.cloud.beyondcorp.clientgateways.v1.ClientGateway)
   ...
   * @return The state.
   */
  com.google.events.cloud.beyondcorp.clientgateways.v1.ClientGateway.State getState();
