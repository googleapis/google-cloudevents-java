...
public interface LogsPolicyOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.events.cloud.batch.v1.LogsPolicy)
   ...
   */
  com.google.events.cloud.batch.v1.LogsPolicy.Destination getDestination();
