...
public interface RuntimeSoftwareConfigOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.events.cloud.notebooks.v1.RuntimeSoftwareConfig)
   ...
   * <code>repeated .google.events.cloud.notebooks.v1.ContainerImage kernels = 8;</code>
   */
  com.google.events.cloud.notebooks.v1.ContainerImageOrBuilder getKernelsOrBuilder(int index);
