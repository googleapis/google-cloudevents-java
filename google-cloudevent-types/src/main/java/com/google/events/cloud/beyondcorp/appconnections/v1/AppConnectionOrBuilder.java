...
public interface AppConnectionOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.events.cloud.beyondcorp.appconnections.v1.AppConnection)
   ...
   * @return The type.
   */
  com.google.events.cloud.beyondcorp.appconnections.v1.AppConnection.Type getType();
   ...
   * </code>
   */
  com.google.events.cloud.beyondcorp.appconnections.v1.AppConnection.ApplicationEndpointOrBuilder
   ...
   * @return The state.
   */
  com.google.events.cloud.beyondcorp.appconnections.v1.AppConnection.State getState();
   ...
   * @return The gateway.
   */
  com.google.events.cloud.beyondcorp.appconnections.v1.AppConnection.Gateway getGateway();
