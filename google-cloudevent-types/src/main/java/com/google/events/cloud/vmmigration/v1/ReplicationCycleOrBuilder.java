...
public interface ReplicationCycleOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.events.cloud.vmmigration.v1.ReplicationCycle)
   ...
   * <code>repeated .google.events.cloud.vmmigration.v1.CycleStep steps = 9;</code>
   */
  com.google.events.cloud.vmmigration.v1.CycleStepOrBuilder getStepsOrBuilder(int index);
   ...
   * @return The state.
   */
  com.google.events.cloud.vmmigration.v1.ReplicationCycle.State getState();
   ...
   * <code>repeated .google.events.cloud.vmmigration.v1.MigrationWarning warnings = 14;</code>
   */
  com.google.events.cloud.vmmigration.v1.MigrationWarningOrBuilder getWarningsOrBuilder(int index);
}
