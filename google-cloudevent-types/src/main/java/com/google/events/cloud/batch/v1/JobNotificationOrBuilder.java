...
public interface JobNotificationOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.events.cloud.batch.v1.JobNotification)
   ...
   * @return The message.
   */
  com.google.events.cloud.batch.v1.JobNotification.Message getMessage();
