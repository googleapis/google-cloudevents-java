...
public interface DeviceRegistryOrBuilder extends
   ...
   * <code>repeated .google.events.cloud.iot.v1.EventNotificationConfig event_notification_configs = 10;</code>
   */
  com.google.events.cloud.iot.v1.EventNotificationConfigOrBuilder getEventNotificationConfigsOrBuilder(
      int index);
   ...
   */
  java.util.List<com.google.events.cloud.iot.v1.RegistryCredential> 
      getCredentialsList();
  /**
   * <pre>
   * The credentials used to verify the device credentials. No more than 10
   ...
   * <code>repeated .google.events.cloud.iot.v1.RegistryCredential credentials = 8;</code>
   */
  com.google.events.cloud.iot.v1.RegistryCredentialOrBuilder getCredentialsOrBuilder(
      int index);
}
