...
public interface TcpRouteOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.events.cloud.networkservices.v1.TcpRoute)
   ...
   */
  java.util.List<com.google.events.cloud.networkservices.v1.TcpRoute.RouteRule> getRulesList();
   ...
   * <code>repeated .google.events.cloud.networkservices.v1.TcpRoute.RouteRule rules = 5;</code>
   */
  com.google.events.cloud.networkservices.v1.TcpRoute.RouteRule getRules(int index);
   ...
   * <code>repeated .google.events.cloud.networkservices.v1.TcpRoute.RouteRule rules = 5;</code>
   */
  java.util.List<? extends com.google.events.cloud.networkservices.v1.TcpRoute.RouteRuleOrBuilder>
   ...
   * <code>repeated .google.events.cloud.networkservices.v1.TcpRoute.RouteRule rules = 5;</code>
   */
  com.google.events.cloud.networkservices.v1.TcpRoute.RouteRuleOrBuilder getRulesOrBuilder(
      int index);
