...
public interface KeyOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.events.cloud.datastore.v1.Key)
   ...
   * <code>.google.events.cloud.datastore.v1.PartitionId partition_id = 1;</code>
   */
  com.google.events.cloud.datastore.v1.PartitionIdOrBuilder getPartitionIdOrBuilder();
   ...
   * <code>repeated .google.events.cloud.datastore.v1.Key.PathElement path = 2;</code>
   */
  com.google.events.cloud.datastore.v1.Key.PathElementOrBuilder getPathOrBuilder(int index);
}
