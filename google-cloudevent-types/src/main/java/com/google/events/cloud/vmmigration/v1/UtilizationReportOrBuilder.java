...
public interface UtilizationReportOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.events.cloud.vmmigration.v1.UtilizationReport)
   ...
   * @return The state.
   */
  com.google.events.cloud.vmmigration.v1.UtilizationReport.State getState();
   ...
   */
  com.google.events.cloud.vmmigration.v1.UtilizationReport.TimeFrame getTimeFrame();
   ...
   * <code>repeated .google.events.cloud.vmmigration.v1.VmUtilizationInfo vms = 10;</code>
   */
  com.google.events.cloud.vmmigration.v1.VmUtilizationInfoOrBuilder getVmsOrBuilder(int index);
}
