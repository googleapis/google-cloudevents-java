...
public interface ScheduleOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.events.cloud.notebooks.v1.Schedule)
   ...
   * @return The state.
   */
  com.google.events.cloud.notebooks.v1.Schedule.State getState();
   ...
   * <code>repeated .google.events.cloud.notebooks.v1.Execution recent_executions = 10;</code>
   */
  com.google.events.cloud.notebooks.v1.ExecutionOrBuilder getRecentExecutionsOrBuilder(int index);
}
