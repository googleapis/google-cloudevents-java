...
public interface AnalyticsLogDataOrBuilder extends
   ...
   */
  java.util.List<com.google.events.firebase.analytics.v1.EventDimensions> 
      getEventDimList();
  /**
   * <pre>
   * A repeated record of event related dimensions.
   ...
   * <code>repeated .google.events.firebase.analytics.v1.EventDimensions event_dim = 2;</code>
   */
  com.google.events.firebase.analytics.v1.EventDimensionsOrBuilder getEventDimOrBuilder(
      int index);
}
